...
inline bool getDesc( Mat1f& smoothed_img, Mat1f& smoothed_img2, KeyPoint3D& kp, const cv::Mat1f depth_map, cv::Matx33f& K )
{
  ...
  float coverage;
  getGradPatch<OriPatchSize,2>( smoothed_img2, kp, depth_map, K, pt_infos_ori, coverage );
  ...
  getGradPatch<DescPatchSize,1>( smoothed_img, kp, depth_map, K, pt_infos_desc, coverage, kp_ori_rot );
